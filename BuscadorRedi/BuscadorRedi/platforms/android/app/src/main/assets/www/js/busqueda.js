...
function mostrarSugerencias (resp) {
    let articulos = resp.response;
    let sugerencias = '';

    for(let i=0; i<10; i++){
        sugerencias += '<li class="sugerencia" onclick="cambiarValorBusqueda(event)">'+articulos['docs'][i]['dc.title']+'</li>';
    }
